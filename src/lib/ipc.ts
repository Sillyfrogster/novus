...
export function fetchVoiceRegistry(): Promise<VoicePackManifest[]> {
  return invoke<VoicePackManifest[]>("fetch_voice_registry");
}

export function listVoicePacks(): Promise<InstalledVoicePack[]> {
  return invoke<InstalledVoicePack[]>("list_voice_packs");
}

export function downloadVoicePack(manifest: VoicePackManifest): Promise<void> {
  return invoke<void>("download_voice_pack", { manifest });
}

export function deleteVoicePack(packId: string): Promise<void> {
  return invoke<void>("delete_voice_pack", { packId });
}
...
export function synthesizeSentence(
  ...
  return invoke<SynthesisResult>("synthesize_sentence", { packId, voiceId, text, speed });
}

export function ttsShutdown(): Promise<void> {
  return invoke<void>("tts_shutdown");
}
